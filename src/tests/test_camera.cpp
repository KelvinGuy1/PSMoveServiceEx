...
int main(int, char**)
{
    ...
    while (bKeepRunning)
    {
        ...
        else if (std::find(known_keys.begin(), known_keys.end(), wk) != known_keys.end())
        {
            ...
            double val_diff = 0;
            std::string prop_str("cv::CAP_PROP_EXPOSURE");
            ...
            if ((wk == 116) || (wk == 103))
            {
                ...
                prop_str = "cv::CAP_PROP_SHARPNESS";
                val_diff = (wk == 116) ? 1 : -1;
            }
			...
			if ((wk == 117) || (wk == 106))
			{
				...
				prop_str = "cv::CAP_PROP_FRAME_WIDTH";
				val_diff = (wk == 117) ? 1 : -1;
			}
		...
		else if (std::find(known_keys_check.begin(), known_keys_check.end(), wk) != known_keys_check.end())
		{
			...
			std::string prop_str("cv::CAP_PROP_FPS");
